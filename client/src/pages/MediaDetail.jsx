...
import MediaSuggestion from "../components/common/MediaSuggestion";
...
const MediaDetail = () => {
  ...
  return (
    media ? (
      <>
        <ImageHeader imagePath={tmdbConfigs.backdropPath(media.backdrop_path || media.poster_path)} />
        <Box sx={{
                ...
                <Stack spacing={5}>
                  ...
                  <Stack direction="row" spacing={1}>
                    ...
                    <Button
                      ...
                      onClick={() => suggestRef.current.scrollIntoView()}
                    >
                      Suggest
                    </Button>
                  </Stack>
          ...
          {/* media suggestions */}
          <div ref={suggestRef} style={{ paddingTop: "2rem" }}>
            <MediaSuggestion suggestions={media.suggestions} media={media} mediaType={mediaType} />
          </div>
          {/* media suggestions */}
